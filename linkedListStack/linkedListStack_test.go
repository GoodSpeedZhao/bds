...
func TestNewLinkedListStack(t *testing.T) {
	tests := []struct {
		...
		{"TestNewLinkedListStack case1"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			this := NewLinkedListStack()
			if this == nil {
...
func TestNewLinkedListStackWithCapacity(t *testing.T) {
	type args struct {
		capacity int
	}
	tests := []struct {
		...
		{"TestNewLinkedListStackWithCapacity case1", args{-10}, 0},
		{"TestNewLinkedListStackWithCapacity case2", args{10}, 10},
		{"TestNewLinkedListStackWithCapacity case3", args{math.MaxUint32 + 10}, math.MaxUint32},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			this := NewLinkedListStackWithCapacity(tt.args.capacity)
			if this == nil {
				t.Errorf("got nil, want Stack")
				return
			}
...
func TestStack_Push(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			this := NewLinkedListStackWithCapacity(tt.capacity)
